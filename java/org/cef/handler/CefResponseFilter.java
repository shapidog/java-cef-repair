...
public interface CefResponseFilter {
     ...
     */
     static final int RESPONSE_FILTER_NEED_MORE_DATA = 0;
    /**
     * Some or all of the pre-filter data was read successfully and all available
     * filtered output has been written.
     */
     static final int RESPONSE_FILTER_DONE = 1;
    /**
     * An error occurred during filtering.
     */
     static final int RESPONSE_FILTER_ERROR = 2;
     ...
     */
    int filter(ByteBuffer dataIn, long dataInSize, long[] dataInRead,
